...
const String intrinsicFile  = calibFilesPath + "Intrinsics.xml";
const String distortionFile = calibFilesPath + "Distortion.xml";
...
int main() 
{
	...
	cvSave(intrinsicFile.c_str(),intrinsic_matrix);
	cvSave(distortionFile.c_str(),distortion_coeffs);
	printf("Files saved.\n\n");
